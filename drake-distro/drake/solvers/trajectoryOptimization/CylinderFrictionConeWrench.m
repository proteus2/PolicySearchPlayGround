classdef CylinderFrictionConeWrench < RigidBodyContactWrench
  ...
  methods
    function obj = CylinderFrictionConeWrench(robot,cylinder_idx,finger_idx,finger_pt,cylinder_axis_dir,cylinder_axis_origin,cylinder_radius,mu,force_normalization_factor,ncp_tol)
      ...
      wrench_sparse_pattern = ones(3,nq+obj.num_pt_F+obj.num_pts);
      wrench_sparse_pattern(1,nq+obj.num_pt_F+(1:obj.num_pts)) = 0;
      ...
      obj.complementarity_flag = true; %TODO: Turn this on to get the complementarity constraint
