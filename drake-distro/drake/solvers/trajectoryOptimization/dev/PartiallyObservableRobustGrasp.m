classdef PartiallyObservableRobustGrasp < NonlinearProgram
  ...
  methods
    function obj = PartiallyObservableRobustGrasp(hand_urdf,hand_tip_names, hand_tip_pts,...
        ...
        uncertainty_handle,num_samples,ncp_tol,obj_height)
