function testRobustGrasp
    ...
    for rollidx = 1:size(roll_list,2)
        ...
        for idx=1:size(x_list,2)
            ...
            fname = sprintf('traj_x=%d,roll=%d,',x,roll)
...
inertia(1,1) = 0.01+rand_num*1e-3;
inertia(2,2) = 0.01+rand_num*1e-3;
inertia(3,3) = 0.04+rand_num*5e-3;
theta = rand_num*2*pi;
