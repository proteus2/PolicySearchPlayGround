classdef SingleBodyDynamicsFullKinematicsPlanner < ComDynamicsFullKinematicsPlanner
  ...
  methods(Access = protected)
    ...
    function obj = addCentroidalDynamicConstraints(obj)
      ...
      for i = 1:obj.N
        com_cnstr = FunctionHandleConstraint(zeros(3,1),zeros(3,1), obj.nq+3, @comMatch,1);
        ...
        k_cnstr = FunctionHandleConstraint(zeros(3,1),zeros(3,1),obj.nq+obj.nv+3,@angularMomentumMatch,1);
