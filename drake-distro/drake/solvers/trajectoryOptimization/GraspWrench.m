classdef GraspWrench < RigidBodyContactWrench
  ...
  methods
    ...
    function [normal,dnormal] = normalDirection(obj,kinsol)
      error('Drake:GraspWrench:normalDirection is not defined for GraspWrench');
    end
    
    function [pos_t,dpos_t] = tangentialContactPosition(obj,kinsol)
      error('Drake:GraspWrench:tangentialContactPosition is not defined for GraspWrench');
    end
  end
