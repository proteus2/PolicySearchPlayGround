...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      subroutine s3dfltA
     &   ( n, lvlHes, maxR, maxS, mQNmod, iw, leniw )
     ...
     &     kreset, never, QPslvr
      ...
      if (QPslvr .eq. CG  .or.  maxR   .lt. maxS) then
         ...
         if (lvlHes .lt. 0 .and.  n  .gt. 75  )
     &                        lvlHes = LM
         if (lvlHes .lt. 0 .and.  n  .le. 75  )
     &                        lvlHes = FM
         if (lvlHes .eq. FM ) mQNmod = kReset
         if (mQNmod .lt. 0  ) mQNmod = 10
      end if

      end ! subroutine s3dfltA
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     nParPr, nPr1, nPr2, ObjRow, QPslvr, stkyOp
      double precision
     &     bigdx, bigFx,
     &     eps, epsrf, etarg,
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 1000 format(' ===>  WARNING - too many rows.' )
 1200 format(' ===>  WARNING - Column ', i6,
     &       ' of the Jacobian is empty.')
 1300 format(' ===>  WARNING - Row    ', i6,
     &       ' of the Jacobian is empty.')
 1500 format(' ===>  No objective row specified ---',
     &             ' finding a feasible point.')
 2000 format(' XXX  Nonlinear derivative element    k = ', i6,
     &             ',  row ',   i6, ' column ', i6,
     &             ' is out of range.' )
 2010 format(' XXX  Linear    derivative element    k = ', i6,
     &             ',  row ',   i6, ' column ', i6,
     &             ' is out of range.' )
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     &     nParPr, nPr1, nPr2, QPslvr, stkyOp
      double precision
     &     bigdx, bigFx,
     &     eps, epsrf, etarg,
     &     fdint1, fdint2, scltol,
