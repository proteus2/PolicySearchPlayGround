/* ../src/sqopt.f -- translated by f2c (version 20090411).
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* Subroutine */ int sqopt_(char *start, U_fp qphx, integer *m, integer *n, 
	integer *nea, integer *nname, integer *lencobj, integer *ncolh, 
...
/*     ------------------------------------------------------------------ */
    ...
    /* Function Body */
    snkerq_(start, (U_fp)qphx, (U_fp)sqlog_, m, n, nea, nname, lencobj, ncolh,
