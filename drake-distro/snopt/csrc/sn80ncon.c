/* ../src/sn80ncon.f -- translated by f2c (version 20090411).
...
/* Sloppy phase 2 opt tol */
	    s5qp_(&inform__, &c__6, probtag, &elastc, &subopt, (U_fp)s8pphx_, 
		    ...
		    needx, lenr, m, maxs, mbs, n, nb, ndegen, &hcalls, nnl0, 
...
/* Subroutine */ int s8getr_(integer *iexit, U_fp hprod, U_fp hprod1, integer 
	*htype, integer *hcalls, logical *gotr, integer *typelu, integer *
...
/* ----------------------------------------------------------- */
	    s5hz_(&inform__, (U_fp)hprod, (U_fp)hprod1, &maxr, lenr, minimz, 
		    m, mbs, n, nb, nnh, ns, hcalls, ne, nlocj, &locj[1], &
...
/* -------------------------------------------------- */
			...
			snprnt_(&c__23, str, &iw[1], leniw, (ftnlen)80);
			*htype = 2;
			s8h0_(htype, nnh, u0ii, &iw[1], leniw, &rw[1], lenrw);
		    } else {
/* -------------------------------------------------- */
...
/* -------------------------------------------------- */
		...
		if (rcheck) {
		    s5rchk_(iexit, (U_fp)hprod, (U_fp)hprod1, itn, minimz, &
			    maxr, lenr, m, mbs, n, nb, hcalls, nnh, ns, ne, 
	...
	negcon)
{
    ...
    /* Local variables */
    static integer k, ir, last, nlocg;
...
/* Subroutine */ int s8iqn_(integer *iexit, integer *info, U_fp hprod, U_fp 
	hprod1, U_fp mnrlog, integer *htype, integer *hcalls, logical *elastc,
	 logical *gotr, integer *itn, integer *itqp, integer *lenr, integer *
	m, integer *maxs, integer *mbs, integer *n, integer *nb, integer *
	nncon0, integer *nncon, integer *nnobj0, integer *nnobj, integer *
	nnl0, integer *nnl, integer *ns, integer *ndegen, integer *mjrprt, 
	integer *mnrprt, integer *minimz, integer *iobj, doublereal *condhz, 
	doublereal *sclobj, doublereal *objadd, doublereal *objqp, doublereal 
	*tolfp, doublereal *tolqpk, doublereal *tolx, integer *ninf, 
	doublereal *sinf, doublereal *wtinf, doublereal *u0ii, doublereal *
	pinorm, integer *ne, integer *nlocj, integer *locj, integer *indj, 
	doublereal *jcol, integer *hetype, integer *hestat, integer *hfeas, 
	integer *hs, integer *kbs, doublereal *ascale, doublereal *bl, 
	doublereal *bu, doublereal *blbs, doublereal *bubs, doublereal *gbs, 
	doublereal *gqp, doublereal *gobj, doublereal *hdx, doublereal *pbs, 
	doublereal *pi, doublereal *r__, doublereal *rc, doublereal *rg, 
	doublereal *rg2, doublereal *qprhs, doublereal *x, doublereal *xbs, 
	doublereal *xqp0, doublereal *xqp, integer *iy, integer *iy1, 
	doublereal *y, doublereal *y1, doublereal *y2, char *cu, integer *
	lencu, integer *iu, integer *leniu, doublereal *ru, integer *lenru, 
	char *cw, integer *lencw, integer *iw, integer *leniw, doublereal *rw,
	 integer *lenrw, ftnlen cu_len, ftnlen cw_len)
{
    ...
    extern /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    static logical newlu;
    static integer lureq, nswap, zngqp;
    extern /* Subroutine */ int s2bfac_(integer *, integer *, logical *, 
	    logical *, logical *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, doublereal 
    ...
    /* Fortran I/O blocks */
    static icilist io___139 = { 0, str, 0, fmt_1500, 80, 1 };
    static icilist io___140 = { 0, str, 0, fmt_1800, 80, 1 };
    static icilist io___141 = { 0, str, 0, fmt_1100, 80, 1 };
    static icilist io___142 = { 0, str, 0, fmt_1200, 80, 1 };
    static icilist io___143 = { 0, str, 0, fmt_1300, 80, 1 };
    static icilist io___146 = { 0, str, 0, fmt_1400, 80, 1 };
    static icilist io___147 = { 0, str, 0, fmt_1510, 80, 1 };
    static icilist io___148 = { 0, str, 0, fmt_1600, 80, 1 };
    static icilist io___149 = { 0, str, 0, fmt_1950, 80, 1 };
    static icilist io___150 = { 0, str, 0, fmt_1800, 80, 1 };
    static icilist io___151 = { 0, str, 0, fmt_1900, 80, 1 };
    static icilist io___152 = { 0, str, 0, fmt_1950, 80, 1 };
	...
	if (! done && luok) {
	    ...
	    s5qn_(&inform__, &c__4, probtag, elastc, &subopt, (U_fp)hprod, (
		    U_fp)hprod1, (U_fp)mnrlog, gotr, &needlu, &typelu, &needx,
		     lenr, m, maxs, mbs, n, nb, ndegen, hcalls, &ngqp0, &
...
/*        after any switch to elastic mode. */
	...
	s5qn_(&inform__, &c__5, probtag, elastc, &subopt, (U_fp)hprod, (U_fp)
		hprod1, (U_fp)mnrlog, gotr, &needlu, &typelu, &needx, lenr, m,
		 maxs, mbs, n, nb, ndegen, hcalls, &ngqp0, &ngqp, nnobj0, 
...
/* Subroutine */ int s8iqp_(integer *iexit, integer *info, U_fp hprod, U_fp 
	...
	nncon0, integer *nncon, integer *nnobj0, integer *nnobj, integer *
	nnl0, integer *nnl, integer *ns, integer *ndegen, integer *mjrprt, 
	integer *mnrprt, integer *minimz, integer *iobj, doublereal *sclobj, 
	doublereal *objadd, doublereal *objqp, doublereal *tolfp, doublereal *
	tolqpk, doublereal *tolx, integer *ninf, doublereal *sinf, doublereal 
	*wtinf, doublereal *u0ii, doublereal *pinorm, integer *ne, integer *
	nlocj, integer *locj, integer *indj, doublereal *jcol, integer *
	hetype, integer *hestat, integer *hfeas, integer *hs, integer *kbs, 
	doublereal *ascale, doublereal *bl, doublereal *bu, doublereal *blbs, 
	doublereal *bubs, doublereal *gbs, doublereal *gqp, doublereal *gobj, 
	doublereal *hdx, doublereal *pbs, doublereal *pi, doublereal *r__, 
	doublereal *rc, doublereal *rg, doublereal *qprhs, doublereal *x, 
	...
	doublereal *rw, integer *lenrw, ftnlen cu_len, ftnlen cw_len)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___186 = { 0, str, 0, fmt_1500, 80, 1 };
    static icilist io___187 = { 0, str, 0, fmt_1100, 80, 1 };
    static icilist io___188 = { 0, str, 0, fmt_1200, 80, 1 };
    static icilist io___189 = { 0, str, 0, fmt_1300, 80, 1 };
    static icilist io___192 = { 0, str, 0, fmt_1400, 80, 1 };
    static icilist io___193 = { 0, str, 0, fmt_1510, 80, 1 };
    static icilist io___194 = { 0, str, 0, fmt_1600, 80, 1 };
    static icilist io___195 = { 0, str, 0, fmt_1700, 80, 1 };
    static icilist io___196 = { 0, str, 0, fmt_1900, 80, 1 };
    static icilist io___197 = { 0, str, 0, fmt_1800, 80, 1 };
...
/* The basis is refactorized if necessary. */
	    s8getr_(iexit, (U_fp)hprod, (U_fp)hprod1, htype, hcalls, gotr, &
		    typelu, &lureq, itn, lenr, m, mbs, n, nb, nncon0, nncon, &
		    nnh, ns, mjrprt, minimz, iobj, u0ii, &targth, &targtz, ne,
		     nlocj, &locj[1], &indj[1], &jcol[1], &hs[1], &kbs[1], &
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* subroutine  s8mrt */
/* Subroutine */ int s8pphx_(U_fp hprod, integer *hcalls, integer *nnh, 
	...
	integer *iw, integer *leniw, doublereal *rw, integer *lenrw)
{
    ...
    static integer htype;
    static doublereal pivot, fdint1, pivabs;
	...
	integer *iw, integer *leniw)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___266 = { 0, str, 0, fmt_1000, 80, 1 };
