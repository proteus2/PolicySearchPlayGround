...
/*     ================================================================== */
    s_copy(title, "S Q O P T  7.2-12   (Feb 2013)", (ftnlen)30, (ftnlen)30);
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* subroutine sqSpec */
/* Subroutine */ int sqhx_(S_fp usrhx, integer *hcalls, integer *nnh, 
	doublereal *x, doublereal *hx, integer *sqstat, char *cu, integer *
