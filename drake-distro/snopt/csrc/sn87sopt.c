/* ../src/sn87sopt.f -- translated by f2c (version 20090411).
	...
	ftnlen solver_len, ftnlen names_len, ftnlen cu_len, ftnlen cw_len)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___315 = { 0, str, 0, fmt_1900, 133, 1 };
    static icilist io___316 = { 0, str, 0, fmt_1910, 133, 1 };
    static icilist io___317 = { 0, str, 0, fmt_1915, 133, 1 };
    static icilist io___318 = { 0, str, 0, fmt_1920, 133, 1 };
    static icilist io___319 = { 0, str, 0, fmt_1930, 133, 1 };
    static icilist io___320 = { 0, str, 0, fmt_1950, 133, 1 };
    static icilist io___321 = { 0, str, 0, fmt_1955, 133, 1 };
    static icilist io___322 = { 0, str, 0, fmt_1960, 133, 1 };
    static icilist io___323 = { 0, str, 0, fmt_1962, 133, 1 };
    static icilist io___324 = { 0, str, 0, fmt_1970, 133, 1 };
    static icilist io___325 = { 0, str, 0, fmt_1973, 133, 1 };
    static icilist io___326 = { 0, str, 0, fmt_1975, 133, 1 };
...
/*     Zap the pi(i) to prevent them being printed without being set. */
    ...
    if (numlc > 0) {
	dload_(&numlc, &c_b17, &pi[*nncon + 1], &c__1);
    }
	 ...
	 integer *lenrw, ftnlen cu_len, ftnlen cw_len)
{
    ...
    static integer isumm, ksumm, lureq, maxvi, nswap, nskip;
...
/* Initialize dyCon = 0, yCon = pi(qp) */
		...
		dload_(nncon, &c_b17, &dycon[1], &c__1);
	    } else {
...
/*           ------------------------------------------------------------ */
	(*mjrlog)(&iabort, info, &iw[202], ktcond, &mjrprt, minimz, n, nb, 
		...
		lencu, &iu[1], leniu, &ru[1], lenru, cw + 8, lencw, &iw[1], 
		leniw, &rw[1], lenrw, (ftnlen)8, (ftnlen)8);
	(*snstop)(&iabort, info, &c__202, ktcond, &mjrprt, minimz, m, maxs, n,
		 nb, nncon0, nncon, nnobj0, nnobj, ns, itn, nmajor, nminor, &
