/* ../src/sn57qopt.f -- translated by f2c (version 20090411).
...
/* Subroutine */ int s5solv_(integer *iexit, char *solver, integer *start, 
	U_fp hprod, U_fp hprod1, U_fp qplog, integer *hcalls, logical *gotr, 
	integer *m, integer *n, integer *nb, integer *nnh0, integer *nnh, 
	integer *nname, integer *ngqp, integer *ngobj0, integer *ngobj, 
	integer *iobj, doublereal *objadd, doublereal *objqp, doublereal *
	objtru, integer *ninf, doublereal *sinf, integer *ne, integer *nloca, 
	integer *loca, integer *inda, doublereal *acol, doublereal *bl, 
	doublereal *bu, doublereal *gobj, char *names, integer *nrhs0, 
	integer *nrhs, doublereal *rhs, integer *lenx0, integer *nx0, 
	doublereal *x0, integer *hetype, integer *hs, doublereal *x, 
	doublereal *pi, doublereal *rc, integer *ns, char *cu, integer *lencu,
	 integer *iu, integer *leniu, doublereal *ru, integer *lenru, char *
	cw, integer *lencw, integer *iw, integer *leniw, doublereal *rw, 
	integer *lenrw, ftnlen solver_len, ftnlen names_len, ftnlen cu_len, 
	ftnlen cw_len)
{
    /* Format strings */
    ...
    /* Fortran I/O blocks */
    static icilist io___70 = { 0, str, 0, fmt_1900, 132, 1 };
    static icilist io___71 = { 0, str, 0, fmt_1910, 132, 1 };
    static icilist io___72 = { 0, str, 0, fmt_1920, 132, 1 };
    static icilist io___73 = { 0, str, 0, fmt_1930, 132, 1 };
    static icilist io___74 = { 0, str, 0, fmt_1970, 132, 1 };
    static icilist io___75 = { 0, str, 0, fmt_1975, 132, 1 };
...
/* ----------------------------------------------------------------- */
    s2amat_(&c__1, &mnrprt, m, n, nb, &nncon, &nnjac, &nnobj, iobj, &numlc, &
...
/*     ================================================================== */
	...
	if (iw[208] == 0) {
	    s5sqp_(&inform__, (U_fp)hprod, (U_fp)hprod1, (U_fp)qplog, gotr, &
		    prob, &lenr, m, &maxs, &mbs, n, nb, &ndegen, hcalls, &
...
/* Writing concatenation */
    ...
    if (prob == 2) {
	s_wsfi(&io___72);
	do_fio(&c__1, (char *)&(*hcalls), (ftnlen)sizeof(integer));
	...
	*objtru = *objadd;
	...
	if (*ngqp > 0) {
	    s5qpfg_((U_fp)hprod, (U_fp)hprod1, ngqp, ngobj0, ngobj, nnh, &
		    sqstat, hcalls, objqp, &gobj[1], &rw[lgqp], lenx0, nx0, &
	...
	integer *leniw, doublereal *rw, integer *lenrw, ftnlen cw_len)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___251 = { 0, str, 0, fmt_1000, 120, 1 };
    static icilist io___252 = { 0, str, 0, fmt_1200, 120, 1 };
    static icilist io___253 = { 0, str, 0, fmt_1300, 120, 1 };
    static icilist io___254 = { 0, str, 0, fmt_1100, 120, 1 };
...
/* Subroutine */ int s5sqp_(integer *iexit, U_fp hprod, U_fp hprod1, U_fp 
	...
	integer *maxs, integer *mbs, integer *n, integer *nb, integer *ndegen,
	 integer *hcalls, integer *ngqp0, integer *ngqp, integer *ngobj0, 
	...
	leniw, doublereal *rw, integer *lenrw, ftnlen cu_len, ftnlen cw_len)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___295 = { 0, str, 0, fmt_1000, 120, 1 };
    static icilist io___296 = { 0, str, 0, fmt_1200, 120, 1 };
    static icilist io___297 = { 0, str, 0, fmt_1300, 120, 1 };
    static icilist io___304 = { 0, str, 0, fmt_1100, 120, 1 };
    static icilist io___305 = { 0, str, 0, fmt_1600, 120, 1 };
    static icilist io___306 = { 0, str, 0, fmt_1700, 120, 1 };
    static icilist io___307 = { 0, str, 0, fmt_1800, 120, 1 };
...
L500:
	...
	s5qp_(&inform__, &c__0, probtag, &elastc, &subopt, (U_fp)hprod, (U_fp)
		...
		maxs, mbs, n, nb, ndegen, hcalls, ngqp0, &zngqp, ngobj0, 
...
/* -------------------------------------------------------------- */
	if (! (*gotr) || lureq > 0) {
	    s5getr_(iexit, (U_fp)hprod, (U_fp)hprod1, hcalls, gotr, &typelu, &
		    lureq, itn, lenr, m, mbs, n, nb, nnh, ns, &prtlvl, minimz,
		     iobj, &targth, &targtz, ne, nloca, &loca[1], &inda[1], &
		    acol[1], &hs[1], &kbs[1], &bl[1], &bu[1], &blbs[1], &bubs[
		    1], &r__[1], nrhs0, nrhs, &rhs[1], &x[1], &xbs[1], &iy[1],
...
/* -------------------------------------------------------------- */
	...
	s5qp_(&inform__, prob, probtag, &elastc, &subopt, (U_fp)hprod, (U_fp)
		hprod1, (U_fp)qplog, gotr, &needlu, &typelu, &needx, lenr, m, 
		maxs, mbs, n, nb, ndegen, hcalls, ngqp0, ngqp, ngobj0, ngobj, 
	...
	ftnlen cu_len, ftnlen cw_len)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___345 = { 0, str, 0, fmt_1000, 120, 1 };
    static icilist io___346 = { 0, str, 0, fmt_1200, 120, 1 };
    static icilist io___347 = { 0, str, 0, fmt_1300, 120, 1 };
    static icilist io___354 = { 0, str, 0, fmt_1100, 120, 1 };
    static icilist io___355 = { 0, str, 0, fmt_1800, 120, 1 };
...
/* Subroutine */ int s5stat_(integer *status, integer *iw, integer *leniw)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___357 = { 0, str, 0, fmt_9999, 80, 1 };
