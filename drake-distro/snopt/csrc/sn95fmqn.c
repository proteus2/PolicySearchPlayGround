/* ../src/sn95fmqn.f -- translated by f2c (version 20061008).
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* Subroutine */ int s9fmh0_(integer *htype, integer *nnh, doublereal *hcndbd,
	 doublereal *u0pre, doublereal *hd, integer *lenu, doublereal *u, 
	integer *nqnmod)
{
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* subroutine s9FMH0 */
/* Subroutine */ int s9fmup_(integer *update, integer *htype, integer *nnh, 
...
/*        --------------------------------------------------------------- */
	s9fmh0_(htype, nnh, hcndbd, u0pre, &hd[1], lenu, &u[1], nqnmod);
    } else {
/*        --------------------------------------------------------------- */
