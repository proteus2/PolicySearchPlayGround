	...
	ftnlen cw_len)
{
    ...
    extern /* Subroutine */ int s5inf_(integer *, doublereal *, integer *, 
...
/* jstFea is turned off once a step is taken. */
	    s5inf_(&nbs, &featol, ninf, sinf, &hfeas[1], &blbs[1], &bubs[1], &
		    gbs[1], &xbs[1]);
	    if (*ninf > 0) {
...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* subroutine s5hs */
/* Subroutine */ int s5inf_(integer *nbs, doublereal *featol, integer *ninf, 
	doublereal *sinf, integer *hfeas, doublereal *blbs, doublereal *bubs, 
	doublereal *gbs, doublereal *xbs)
{
    /* System generated locals */
    integer i__1;
...
/* definition of an infinite bound */
    *nrhslp = *m;
    s2aprd_(&c__0, &eps0, ne, nloca, &loca[1], &inda[1], &acol[1], &c_b69, &x[
	    1], n, &c_b5, &y[1], m);
    daxpy_(nrhslp, &c_b150, &x[*n + 1], &c__1, &y[1], &c__1);
    if (*nrhs > 0) {
	daxpy_(nrhs, &c_b150, &rhs[1], &c__1, &y[1], &c__1);
    }
	...
	lenrw)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___187 = { 0, str, 0, fmt_1000, 50, 1 };
    static icilist io___188 = { 0, str, 0, fmt_1100, 50, 1 };
	...
	integer *iw, integer *leniw, doublereal *rw, integer *lenrw)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___219 = { 0, str, 0, fmt_1000, 100, 1 };
	...
	lenrw)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___237 = { 0, str, 0, fmt_1000, 110, 1 };
    static icilist io___238 = { 0, str, 0, fmt_1001, 110, 1 };
...
/*     ------------------------------------------------------------------ */
    ...
    s2aprd_(&c__0, &eps0, ne, nloca, &loca[1], &inda[1], &acol[1], &c_b150, &
	    x[1], n, &c_b69, &y[1], m);
	...
	stepp)
{
    ...
    static doublereal pivabs, pivmaxf, pivmaxi, stepmin;
