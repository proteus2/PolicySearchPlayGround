/* ../src/sn25bfac.f -- translated by f2c (version 20090411).
	...
	integer *lenrw)
{
    ...
    static integer indr, locr, more, newi, newr;
    ...
    static integer btask, ntask, ptask;
    static logical prnt10;
    static integer maxiw, maxrw;
    extern /* Subroutine */ int s2bkbs_(integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *, integer *), s2newb_(integer *, 
	    integer *, integer *, integer *, integer *, integer *, integer *, 
	    integer *, integer *, integer *), s2sing_(integer *, integer *, 
	    integer *, integer *, integer *, doublereal *, integer *, integer 
	    *, doublereal *, doublereal *, integer *, integer *, doublereal *,
	     integer *, integer *), s2tols_(integer *, logical *, integer *, 
	    integer *, integer *, doublereal *, integer *), s5setx_(integer *,
	     integer *, integer *, integer *, integer *, integer *, integer *,
    ...
    static integer lprdbg, nslack, lenalu, inform__, nonlin;
    ...
    /* Fortran I/O blocks */
    static icilist io___25 = { 0, str, 0, fmt_1005, 72, 1 };
    static icilist io___30 = { 0, str, 0, fmt_2000, 72, 1 };
    static icilist io___32 = { 0, str, 0, fmt_3000, 72, 1 };
    static icilist io___39 = { 0, str, 0, fmt_1100, 72, 1 };
    static icilist io___40 = { 0, str, 0, fmt_2000, 72, 1 };
    static icilist io___46 = { 0, str, 0, fmt_7000, 72, 1 };
    static icilist io___47 = { 0, str, 0, fmt_9032, 72, 1 };
    static icilist io___51 = { 0, str, 0, fmt_9080, 72, 1 };
    static icilist io___52 = { 0, str, 0, fmt_9081, 72, 1 };
    static icilist io___53 = { 0, str, 0, fmt_9082, 72, 1 };
    static icilist io___54 = { 0, str, 0, fmt_9101, 72, 1 };
	...
	maxrw, integer *liwest, integer *lrwest, integer *iw, integer *leniw)
{
    static integer ip, iq, mbs, lua, mlu, nlu, indc, locc, lenc, mina, indr, 
	    locr, iploc, iqloc, lenri, necola, lenalu, maxlui, lastiw, maxlur,
	     lastrw;
	...
	integer *iw, integer *leniw, doublereal *rw, integer *lenrw)
{
    ...
    /* Local variables */
    static integer i__, j, k, iq, ir, nz, locc, lenc, locr;
    static doublereal oldl1;
    extern /* Subroutine */ int iload_(integer *, integer *, integer *, 
	    integer *);
    static integer iploc, iqloc, lenri, oldtp;
...
/*        y is an output parameter, used by s2sing. */
	lu1fac_(m, m, &nz, lenalu, &iw[151], &rw[151], &alu[1], &indc[1], &
		...
		iw[locr], &iw[iploc], &iw[iqloc], &iy[1], &iy1[1], &y[1], 
		iexit);
	...
	*x, integer *iw, integer *leniw)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___136 = { 0, str, 0, fmt_1000, 72, 1 };
    static icilist io___137 = { 0, str, 0, fmt_1100, 72, 1 };
	...
	integer *iw, integer *leniw, doublereal *rw, integer *lenrw)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___152 = { 0, str, 0, fmt_1000, 72, 1 };
