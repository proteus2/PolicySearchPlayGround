...
#ifndef _bot_frames_update_t_h
#define _bot_frames_update_t_h

#ifdef __cplusplus
extern "C" {
#endif

typedef struct _bot_frames_update_t bot_frames_update_t;
struct _bot_frames_update_t
{
    int64_t    utime;
    char*      frame;
    char*      relative_to;
...
typedef struct _bot_frames_update_t_subscription_t bot_frames_update_t_subscription_t;
typedef void(*bot_frames_update_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const bot_frames_update_t *msg, void *user);

int bot_frames_update_t_publish(lcm_t *lcm, const char *channel, const bot_frames_update_t *p);
bot_frames_update_t_subscription_t* bot_frames_update_t_subscribe(lcm_t *lcm, const char *channel, bot_frames_update_t_handler_t f, void *userdata);
