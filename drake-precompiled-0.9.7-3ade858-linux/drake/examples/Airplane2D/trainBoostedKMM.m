function [controller] = trainBoostedKMM(x0_list,n_mmd_itern,alpha_list)
    load('RF_seed');
    controller = BoostedKMMController(RF_seed);
    dt = 0.001;        
    n_kmm_limit = 50;
    gamma = 0.004;
    for MMD_iteration = 1:n_mmd_itern
            ...
            for x0_idx=1:size(x0_list,2)
                ...
                for alpha_idx=1:numel(alpha_list) 
                    ...
                    [x,y] = turnTrajToData(xtraj_ref,utraj_ref,t,[alpha;x0]);
