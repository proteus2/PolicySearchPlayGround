fname = 'cost_list_all_alpha_all_x0_no_agg_repmat=1';
load(fname);
...
hold on; errorbar([-c1_mean(1,2),-c1_mean(2,2),-c1_mean(3,2),-topt_mean(1,2)],[c1_CI(2),c1_CI(2),c1_CI(2),topt_CI(2)],'o');
