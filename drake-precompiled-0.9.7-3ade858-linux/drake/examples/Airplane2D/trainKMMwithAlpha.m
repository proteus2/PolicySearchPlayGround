...
train_alpha_list = train_alpha_list(1);
train_x0_list = train_x0_list(:,1:10);
% [controller] = trainBoostedKMM(train_x0_list,n_mmd_iterddn,train_alpha_list);

 [controller] = trainKMM(train_x0_list,n_mmd_itern,train_alpha_list);
%  save('kmm_controller','controller');
% [controller] = trainBoosting(train_x0_list,n_mmd_itern,train_alpha_list);
% save('BoostedKMM_controller_new','controller');
