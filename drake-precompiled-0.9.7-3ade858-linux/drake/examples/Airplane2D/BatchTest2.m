...
for idx=1:size(x0_alpha_list,2)
    	...
    	fprintf('Will be completing=%0.1f percent, Learning Curve, MMD\n', idx/size(x0_alpha_list,2) *100);
        if trainTest
...
save('mmd,sup,dagg_train_error.mat','cost_list_all_alpha','alpha_list','traj_list_all_alpha','test_x0_list','traj_opt_list_all_alpha');
% 
