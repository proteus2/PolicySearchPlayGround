classdef PolicySearchOptimization < NonlinearProgram
  %PolicySearchOptimization An abstract class for direct method approaches to
  % policy search
  % This class performs optimization of the form:
  % min_theta J(theta) = \int_{t0}^{tf} g(x(t),pi_{theta}(x(t))dt 
  %                     s.t. for all x(t), xdot(t) = f(x(t),u(t))
  %                                  x(t0) = x_0
  ...
  methods
    function obj = PolicySearchOptimization(plant,N,options)
    % function obj =
